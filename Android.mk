...
LOCAL_MODULE_OWNER := sony
LOCAL_SRC_FILES := proprietary/app/FidoClient/FidoClient.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE_OWNER := sony
LOCAL_SRC_FILES := proprietary/app/FidoCryptoService/FidoCryptoService.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := TimeShiftCamera-release
LOCAL_MODULE_OWNER := sony
LOCAL_SRC_FILES := proprietary/priv-app/TimeShiftCamera-release/TimeShiftCamera-release.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_SRC_FILES := proprietary/rootfs/sbin/ffu
LOCAL_MODULE_TAGS := optional
...
LOCAL_MODULE_PATH := $(TARGET_ROOT_OUT_SBIN)
LOCAL_UNSTRIPPED_PATH := $(TARGET_ROOT_OUT_SBIN_UNSTRIPPED)
LOCAL_SRC_FILES := proprietary/rootfs/sbin/wait4tad_static
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := EXECUTABLES
include $(BUILD_PREBUILT)
